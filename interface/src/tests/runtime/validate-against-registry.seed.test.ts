...
import { baseComponentRegistry } from "@/runtime/component-registry";
import { getDataSource } from "@/runtime/data/registry";
import { validateAgainstRegistry } from "@/runtime/validate-against-registry";
 ...
 * production seed pages (`/os/headless`, `/os/headless/customers`) - the
