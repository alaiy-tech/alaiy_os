...
export function AccountSwitcher({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-52 space-y-1 rounded-lg" side="bottom" align="end" sideOffset={4}>
        ...
        <div className="rounded-lg bg-muted/60 px-2.5 py-2">
          ...
          <Button variant="default" size="sm" className="mt-2 w-full justify-center">
            Top up credits
          </Button>
        </div>
      </DropdownMenuContent>
