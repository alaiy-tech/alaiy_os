...
import { getPurchaseOrderStatuses } from "@/lib/frappe/purchase-order-stats";
...
export function PurchaseOrders() {
  ...
  const { value: columnPrefs, update: setColumnPrefs } = useListPreference<ColumnPrefs>("purchase-orders:columns", {
  ...
  return (
    <Card className="gap-0">
      ...
      <CardContent className="flex flex-col px-0 gap-0">
        <PurchaseOrderTable table={table} isLoading={isLoading} totalCount={totalCount} />
      </CardContent>
    </Card>
  );
}
