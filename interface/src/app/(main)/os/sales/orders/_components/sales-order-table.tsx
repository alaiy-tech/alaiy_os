...
export function SalesOrderTable({
  ...
  isLoading: boolean;
  totalCount: number;
  /** Worded for the active status tab — "No orders to bill" says more than
   * "No results" when the user is standing on the To Bill tab. */
  emptyMessage?: string;
  onRowClick?: (row: SalesOrderRow) => void;
}) {
    ...
    return rows.map((row) => (
      <TableRow
        ...
        onClick={(event) => {
          ...
          // the select checkbox and the ID link. Let those handle their own
