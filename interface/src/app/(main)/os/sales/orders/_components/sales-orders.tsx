...
export function SalesOrders() {
  ...
  // has to win once.
  const { value: columnPrefs, update: setColumnPrefs } = useListPreference<ColumnPrefs>("sales-orders:columns:v2", {
  ...
  return (
    <div className="flex flex-col gap-4">
      <SalesOrderKpiCards summary={summary} isLoading={isSummaryLoading} hasFailed={summaryFailed} />
      ...
      <Card className="gap-0">
        <CardHeader className="border-b has-data-[slot=card-action]:grid-cols-1 md:has-data-[slot=card-action]:grid-cols-[1fr_auto]">
          ...
          <CardAction className="col-start-1 row-start-auto flex w-full flex-wrap justify-start gap-2 justify-self-stretch md:col-start-2 md:row-span-2 md:row-start-1 md:w-auto md:flex-nowrap md:justify-end md:justify-self-end">
            ...
            <Button size="sm" onClick={() => router.push(`${SALES_ORDER_BASE_PATH}/new`)}>
              <Plus /> New Order
            </Button>
          </CardAction>
        </CardHeader>
