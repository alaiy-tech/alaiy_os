...
// Synthetic fields that don't come back from alaiy_os.api.list_view.get_doctype_fields
// (name isn't a regular DocField; status is derived, not stored) but still need to be
// pickable as columns.
...
// assuming they exist.
export const DEFAULT_COLUMN_ORDER = ["name", "item_name", "item_code", "item_group", "status"];
