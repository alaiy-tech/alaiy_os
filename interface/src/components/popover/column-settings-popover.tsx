  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-0.5">
        ...
        <TooltipWrap label={removeDisabled ? removeDisabledReason : "Remove column"}>
          <button
            type="button"
      ...
      <PopoverContent align="end" className="w-[320px] p-3.5">
        <div>
          <div className="mb-2 flex items-center justify-between">
            <span className="text-[11px] font-medium tracking-[.08em] text-muted-foreground">TABLE COLUMNS</span>
