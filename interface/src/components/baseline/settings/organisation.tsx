      ...
      setInfo((prev) =>
        prev
          ? {
              ...prev,
              squareLogoUrl:
                logoType === "square" ? fileUrl : prev.squareLogoUrl,
              horizontalLogoUrl:
                logoType === "horizontal" ? fileUrl : prev.horizontalLogoUrl,
            }
          : prev,
      );
    ...
    <div className="flex flex-col gap-4">
      ...
      <Card>
        <CardHeader className="border-b">
          ...
          <CardDescription>
            Your organisation's registered identity, currency, and country.
          </CardDescription>
        </CardHeader>
        <CardContent className="pt-2">
          <FieldGroup className="grid gap-6 sm:grid-cols-2">
            ...
            <Field className="gap-1.5">
              ...
              <FieldDescription>
                Set when the company was created - cannot be changed here.
              </FieldDescription>
            </Field>
      ...
      <Card>
        <CardHeader className="border-b">
          ...
          <CardDescription>
            Upload the logos used across the OS - sidebar, login screen, and
            desk.
          </CardDescription>
        </CardHeader>
